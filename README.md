...
- [核心收敛小任务书](docs/core-focus-maintenance-taskbook.md)：冻结扩张、修复阻断 Bug、验证任务闭环与记忆系统。
- [拓展工作区任务书](docs/extension-workspace-taskbook.md)
- [Agent Runtime 连续性任务书](docs/agent-runtime-continuity-taskbook.md)：Context、记忆注册、附件、运行中重入、有界并行、检查点与后台连续执行。
