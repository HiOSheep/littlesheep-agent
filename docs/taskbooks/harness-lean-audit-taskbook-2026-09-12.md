...
来源：`evolve.ts`、`evolve/signal.ts`、`capture.ts`（三者已随极简方案删除，见 `docs/decision/project-status.md` 2026-09-20 条目）、[runner-finalize.ts](../../packages/runner/src/runner-finalize.ts)、[runner-persist.ts](../../packages/runner/src/runner-persist.ts)。任务：HL-08。
