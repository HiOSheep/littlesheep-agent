...
export const runContextFieldOwnership: readonly RunContextFieldContract[] = Object.freeze([
  field({
    ...
    writeStages: ['decide', 'execute', 'recover', 'reply', 'ask_user'],
    lifecycle: 'run-local',
  ...
  field({
    ...
    writeStages: ['runtime-boundary', 'decide', 'runner-restore'],
    lifecycle: 'checkpoint-carried',
  ...
  field({
    ...
    readStages: ['decide', 'execute', 'verify', 'evolve', 'capture', 'finalize', 'runner-restore'],
    writeStages: ['runner-init', 'runtime-boundary', 'evolve', 'finalize', 'runner-restore'],
    lifecycle: 'checkpoint-carried',
  ...
  field({
    ...
    readStages: ['decide', 'execute', 'verify', 'finalize', 'runner-restore'],
    writeStages: ['runner-init', 'runtime-boundary', 'runner-restore'],
    lifecycle: 'checkpoint-carried',
