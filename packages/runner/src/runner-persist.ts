...
export async function persistRunnerPhase<TResult extends PersistableRunnerResult>(
  ...
  try {
    await options.executionLogStore.write({
      ...
      capabilitySnapshot: result.capabilitySnapshot as never,
      capabilityProbe: result.capabilityProbe as never,
      capabilityPermissionEvent: result.capabilityPermissionEvent as never,
