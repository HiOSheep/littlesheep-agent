...
export const LITTLE_SHEEP_MONACO_THEME_DATA = {
  ...
  colors: {
    ...
    'diffEditor.insertedLineBackground': '#153F2B88',
    'diffEditor.insertedTextBackground': '#246B45AA',
    'diffEditor.removedLineBackground': '#4B202588',
    'diffEditor.removedTextBackground': '#7A3038AA',
    'diffEditor.diagonalFill': '#2B2B2B',
    'diffEditor.border': '#303030',
    'diffEditorGutter.insertedLineBackground': '#153F2B',
    'diffEditorGutter.removedLineBackground': '#4B2025',
    'diffEditorOverview.insertedForeground': '#3FBF76AA',
    'diffEditorOverview.removedForeground': '#E05A66AA',
